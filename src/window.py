...
UI_PATH = '/com/github/elbley/aimation/ui/'
...
class DrWindow(Gtk.ApplicationWindow):
	...
	gsettings = Gio.Settings.new('com.github.elbley.aimation')
	...
	animation_toolbar = Gtk.Template.Child()
	animation_flowbox = Gtk.Template.Child()
